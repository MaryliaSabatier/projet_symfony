 ...
 */
final class Version20240710121943 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD auteur_id INT NOT NULL, ADD contenu LONGTEXT NOT NULL, ADD date_creation DATETIME NOT NULL, ADD date_debut DATETIME NOT NULL, ADD date_fin DATETIME NOT NULL, ADD lieu VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE post ADD auteur_id INT NOT NULL, ADD contenu LONGTEXT NOT NULL, ADD date_creation DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement DROP auteur_id, DROP contenu, DROP date_creation, DROP date_debut, DROP date_fin, DROP lieu');
        $this->addSql('ALTER TABLE post DROP FOREIGN KEY FK_5A8A6C8D60BB6FE6');
        $this->addSql('DROP INDEX IDX_5A8A6C8D60BB6FE6 ON post');
        $this->addSql('ALTER TABLE post DROP auteur_id, DROP contenu, DROP date_creation');
    }
}
