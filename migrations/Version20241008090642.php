 ...
 */
final class Version20241008090642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE discussion ADD auteur_id INT NOT NULL, ADD nom VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE discussion DROP auteur_id, DROP nom');
